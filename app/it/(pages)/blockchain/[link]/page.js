...
export default async function PostPage({ params }) {
  ...
  // Get related posts (other Blockchain posts)
  const allBlockchainPosts = getMetadata('블록체인');
  const relatedPosts = allBlockchainPosts
...
export async function generateMetadata({ params, searchParams }) {
  ...
  return { 
    ...
    alternates: {
        canonical: 'https://moyahug.com/it/blockchain/' + resolvedParams.link,
    }
  };
}